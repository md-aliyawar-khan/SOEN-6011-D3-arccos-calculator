...
\begin{center}
\screenshot{pdb-session.png}{5.5cm}
\captiontext{Breakpoint, validation, range reduction, Taylor recurrence, and final result inspection.}
\end{center}
}
...
\begin{center}
\screenshot{uidp-mindmap.png}{6.0cm}
...
[8] & E. W. Weisstein, \emph{Inverse Cosine}, MathWorld. \\


[9] & Concordia University, \emph{UIDP Principles Course Material}. \\

[10] & Python Software Foundation, \emph{tkinter --- Python Interface to Tcl/Tk}. \\

[11] & SOEN 6011 Course Material, \emph{CASTROFF Prompt Framework}. \\
\end{tabular}

\vspace{0.5cm}

\normalsize\textbf{Repository:}\\[0.2cm]
\url{https://github.com/md-aliyawar-khan/SOEN-6011-D3-arccos-calculator}
}
